...
mixin StatelessNavigation {
  Future<E?> pushScreen<E extends Object?>(BuildContext context, Widget screen) {
  ...
  /// ```
  /// {@end-tool}
  Future<E?> popAllAndPush<E extends Object?>(BuildContext context, Widget screen) {
  ...
  /// ```
  /// {@end-tool}
  void popScreen<E extends Object?>(BuildContext context, [E? result]) {
